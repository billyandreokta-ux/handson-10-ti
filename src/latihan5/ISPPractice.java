package latihan5;
import latihan5.good.*; // Uncomment setelah refactoring selesai
import java.util.List;
import java.util.ArrayList;
import latihan5.good.Readable;
import latihan5.good.PdfDocument;
import latihan5.good.ImageDocument;
...
public class ISPPractice {
    public static void main(String[] args) {
        ...
        latihan5.bad.Document pdf = new latihan5.bad.PdfDocument("Contract.pdf");
        ...
        latihan5.bad.Document image = new latihan5.bad.ImageDocument("Photo.jpg");
